...
#pragma clang diagnostic ignored "-Wcast-function-type" // warning: cast between incompatible
...
#pragma GCC diagnostic ignored "-Wcast-function-type" // warning: cast between incompatible function
                                                      // types (for loader)
#endif
  ...
  for (int n = 0; n < draw_data->CmdListsCount; n++) {
    ...
    if (bd->UseBufferSubData) {
      ...
      GL_CALL(glBufferSubData(
        GL_ARRAY_BUFFER, 0, vtx_buffer_size, (const GLvoid*)cmd_list->VtxBuffer.Data));
      GL_CALL(glBufferSubData(
